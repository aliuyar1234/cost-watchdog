...
export default function SettingsPage() {
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<'general' | 'alerts' | 'thresholds' | 'api'>(
    'general',
  );
  ...
  useEffect(() => {
    ...
    const loadSettings = async () => {
      try {
        ...
        const errorMessage =
          err instanceof ApiError ? err.message : 'Fehler beim Laden der Einstellungen';
  ...
  const handleSaveAlerts = async () => {
    ...
    try {
      ...
      const errorMessage =
        err instanceof ApiError ? err.message : 'Fehler beim Speichern der Einstellungen';
      setMessage({ type: 'error', text: errorMessage });
    } finally {
      setSaving(false);
    }
  ...
  const handleSaveThresholds = async () => {
    ...
    try {
      ...
      const errorMessage =
        err instanceof ApiError ? err.message : 'Fehler beim Speichern der Schwellenwerte';
      setMessage({ type: 'error', text: errorMessage });
    } finally {
      setSaving(false);
    }
  ...
  return (
    <div>
      ...
      {activeTab === 'alerts' && (
        <div className="rounded-lg bg-white p-6 shadow">
          <h2 className="mb-6 text-lg font-semibold">Benachrichtigungskanäle</h2>
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              <label className="relative inline-flex cursor-pointer items-center">
                <input
                  ...
                  onChange={(e) =>
                    setAlertSettings({ ...alertSettings, slackEnabled: e.target.checked })
                  }
                  className="peer sr-only"
                />
                <div className="peer h-6 w-11 rounded-full bg-gray-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300"></div>
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              <label className="relative inline-flex cursor-pointer items-center">
                <input
                  ...
                  onChange={(e) =>
                    setAlertSettings({ ...alertSettings, teamsEnabled: e.target.checked })
                  }
                  className="peer sr-only"
                />
                <div className="peer h-6 w-11 rounded-full bg-gray-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300"></div>
              ...
              <div className="ml-13">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setAlertSettings({ ...alertSettings, teamsWebhookUrl: e.target.value })
                    }
          ...
          <div className="mb-6 space-y-3">
            <label className="flex items-center gap-3">
              <input
                ...
                onChange={(e) =>
                  setAlertSettings({ ...alertSettings, notifyOnCritical: e.target.checked })
                }
            ...
            <label className="flex items-center gap-3">
              <input
                ...
                onChange={(e) =>
                  setAlertSettings({ ...alertSettings, notifyOnWarning: e.target.checked })
                }
                className="h-4 w-4 rounded text-blue-600"
              />
              <span className="flex items-center gap-2">
            ...
            <label className="flex items-center gap-3">
              <input
                ...
                onChange={(e) =>
                  setAlertSettings({ ...alertSettings, notifyOnInfo: e.target.checked })
                }
                className="h-4 w-4 rounded text-blue-600"
              />
              <span className="flex items-center gap-2">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={(e) =>
                setAlertSettings({ ...alertSettings, maxAlertsPerDay: Number(e.target.value) })
              }
          ...
          {/* Daily Digest */}
          <h2 className="mb-4 text-lg font-semibold">Tägliche Zusammenfassung</h2>
          <div className="mb-4 flex items-center justify-between">
            <span className="text-sm text-gray-600">
              Tägliche E-Mail-Zusammenfassung aktivieren
            </span>
            <label className="relative inline-flex cursor-pointer items-center">
              <input
                type="checkbox"
                ...
                onChange={(e) =>
                  setAlertSettings({ ...alertSettings, dailyDigestEnabled: e.target.checked })
                }
                className="peer sr-only"
              />
              <div className="peer h-6 w-11 rounded-full bg-gray-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300"></div>
          ...
          {alertSettings.dailyDigestEnabled && (
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setAlertSettings({ ...alertSettings, dailyDigestTime: e.target.value })
                }
      ...
      {activeTab === 'thresholds' && (
        <div className="rounded-lg bg-white p-6 shadow">
          ...
          <p className="mb-6 text-gray-600">
            Passen Sie die Schwellenwerte an, ab denen Kostenabweichungen als Anomalien erkannt
            werden.
          </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setThresholds({ ...thresholds, yoyThreshold: Number(e.target.value) })
                }
                className="w-32 rounded-lg border px-3 py-2"
                min={1}
                max={100}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setThresholds({ ...thresholds, momThreshold: Number(e.target.value) })
                }
                className="w-32 rounded-lg border px-3 py-2"
                min={1}
                max={100}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setThresholds({ ...thresholds, pricePerUnitThreshold: Number(e.target.value) })
                }
                className="w-32 rounded-lg border px-3 py-2"
                min={1}
                max={100}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setThresholds({ ...thresholds, budgetThreshold: Number(e.target.value) })
                }
                className="w-32 rounded-lg border px-3 py-2"
                min={1}
                max={100}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setThresholds({ ...thresholds, minHistoricalMonths: Number(e.target.value) })
                }
                className="w-32 rounded-lg border px-3 py-2"
                min={1}
                max={36}
      ...
      {activeTab === 'api' && (
        <div className="rounded-lg bg-white p-6 shadow">
          <h2 className="mb-6 text-lg font-semibold">API-Schlüssel</h2>
          <p className="mb-6 text-gray-600">
          ...
          <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
            <p className="text-sm text-blue-700">
              API-Schlüssel können unter <strong>Benutzerverwaltung &gt; API-Schlüssel</strong>{' '}
              verwaltet werden. Dort können Sie neue Schlüssel erstellen, bestehende anzeigen und
              widerrufen.
            </p>
          </div>
