...
export const apiKeyRoutes: FastifyPluginAsync = async (fastify) => {
   ...
   * GET /api-keys
   */
  fastify.get<{ Querystring: ApiKeyQuery }>('/', async (request, reply) => {
   ...
   * GET /api-keys/:id
   */
  fastify.get<{ Params: ApiKeyIdParams }>('/:id', async (request, reply) => {
    const user = request.user!;
   ...
   * POST /api-keys
   */
  fastify.post<{ Body: CreateApiKeyBody }>('/', async (request, reply) => {
    const user = request.user!;
   ...
   * DELETE /api-keys/:id
   */
  fastify.delete<{ Params: ApiKeyIdParams }>('/:id', async (request, reply) => {
    const user = request.user!;
